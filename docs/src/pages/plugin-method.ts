import { pluginMethods } from "../data/plugin-methods.ts";
import template from "./plugin-method.html";

export default function pluginMethod(container: Element, params: Record<string, string>) {
