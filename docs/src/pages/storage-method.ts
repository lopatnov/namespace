import { storageMethods } from "../data/storage-methods.ts";
import template from "./storage-method.html";

export default function storageMethod(container: Element, params: Record<string, string>) {
