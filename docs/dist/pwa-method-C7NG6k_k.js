...
//#region src/pages/pwa-method.html
var pwa_method_default = "<div class=\"py-4\">\r\n  <nav aria-label=\"breadcrumb\">\r\n    <ol class=\"breadcrumb\">\r\n      <li class=\"breadcrumb-item\"><a href=\"/pwa\" data-nav>PWA</a></li>\r\n      <li class=\"breadcrumb-item active\" id=\"breadcrumb-title\"></li>\r\n    </ol>\r\n  </nav>\r\n  <h1 class=\"font-monospace mb-4\" id=\"method-title\"></h1>\r\n  <div id=\"methods-list\"></div>\r\n  <a href=\"/pwa\" data-nav class=\"btn btn-outline-secondary btn-sm mt-4\"><i class=\"bi bi-arrow-left me-1\"></i>Back to Overview</a>\r\n</div>\r\n";

//#endregion
//#region src/pages/pwa-method.ts
function pwaMethod(container, params) {
	const group = pwaMethods.find((g) => g.slug === params.method);
	if (!group) {
		container.innerHTML = `
      <div class="py-4">
        <h1>Method not found</h1>
        <p>No documentation for <code>${params.method}</code>.</p>
        <a href="/pwa" data-nav class="btn btn-outline-primary">Back to PWA</a>
      </div>`;
		return;
	}
	container.innerHTML = pwa_method_default;
